<template>
  ...
  <rect x="1.5" y="1.5" width="21" height="21" rx="4.5" fill="url(#paint0_radial_780_6825)"/>
  <rect x="1.5" y="1.5" width="21" height="21" rx="4.5" fill="url(#paint1_radial_780_6825)"/>
  <rect x="1.5" y="1.5" width="21" height="21" rx="4.5" fill="url(#paint2_radial_780_6825)"/>
  ...
  <defs>
    <radialGradient id="paint0_radial_780_6825" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(9 17.25) rotate(-55.3758) scale(19.1397)">
      <stop stop-color="#B13589"/>
      <stop offset="0.79309" stop-color="#C62F94"/>
      <stop offset="1" stop-color="#8A3AC8"/>
    </radialGradient>
    <radialGradient id="paint1_radial_780_6825" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(8.25 23.25) rotate(-65.1363) scale(16.9457)">
      <stop stop-color="#E0E8B7"/>
      <stop offset="0.444662" stop-color="#FB8A2E"/>
      <stop offset="0.71474" stop-color="#E2425C"/>
      <stop offset="1" stop-color="#E2425C" stop-opacity="0"/>
    </radialGradient>
    <radialGradient id="paint2_radial_780_6825" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(0.375001 2.25) rotate(-8.1301) scale(29.1682 6.23877)">
